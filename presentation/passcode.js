(function () {
  ...
  overlay.innerHTML = '<div id="pc-box"><div id="pc-logo">TOIREM</div><div id="pc-sub">Framework Portal</div><p id="pc-label">Enter passcode to continue</p><input id="pc-input" type="password" placeholder="Passcode" autocomplete="off" /><button id="pc-btn">Enter</button><p id="pc-err"></p></div>';
